...
#             i = sorted(tf_idf[word_id].items())
    ...
    with open('term2id.json', 'w') as f:
        json.dump(term2id, f)
        
    with open('id2term.json', 'w') as f:
        json.dump(id2term, f)
        
    with open('docid2url.json', 'w') as f:
        json.dump(docid2url, f)
        
    with open('doc2termlist.json', 'w') as f:
        json.dump(doc2termlist, f)
